  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (err.code === 'auth/popup-blocked') {
        setAuthError("Sign-in pop-up was blocked. Please enable pop-ups for this website in your browser settings (e.g. Safari > Block Pop-ups or Chrome > Pop-ups and redirects) and try again.");
      } else if (err.code === 'auth/iframe-directory-not-found' || err.code === 'auth/operation-not-supported-in-this-environment') {
        setAuthError("Google Login is restricted inside the sandboxed preview iframe. Please click the 'Open in new tab' or external link icon to sign in.");
      } else {
